...
1. Add `keys` to lists
2. Building a form using the Controlled Component technique
...
_"Can't we just put the behavior in a super component, and extend from that using inheritance?"_
...
Using composition is better suited for React 👌
...
<CodeSurferNoZoom
  ...
  steps={[
    ...
    {
      range: [1, 2],
      notes: "Only amount is read from props"
    },
    {
      range: [4, 14],
      notes: "Online status received from Network render prop"
    },
    {}
  ]}
/>
...
<ul style={{ fontSize: "1.2em" }}>
  <li>
    ...
    <Code code="<Network />" />, it becomes easier to understand 😇
  </li>
  <Appear>
    <li>
...
<ul style={{ fontSize: "1.2em" }}>
  <Appear>
    <li>
      Only works if the information is <b>constant</b>
    </li>
...
<ul style={{ fontSize: "1.2em" }}>
  <Appear>
    ...
    <li>
      Use <b>Component setState</b> and <b>Context</b> as long as you can maintain it, it's simpler!
    </li>
  </Appear>
</ul>
