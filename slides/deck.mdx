...
<img
  src="./public/fascinating-meme.jpg"
  style={{ height: "90vh" }}
/>
...
<ul style={{ fontSize: "1.5em" }}>
  <Appear>
    ...
    <li>
      <Code code="<Route/>" /> - To configure which route
...
<CodeSurfer
  ...
  steps={[
    ...
    {
      lines: [6],
      notes: "Show Heroes component when route is /heroes"
    },
    {
      lines: [7],
      notes:
        "Show Villains component when route is /villains"
    },
    {
      lines: [8],
      notes: "Show Home component when route is /"
    }
  ]}
/>
...
that you are _just_ passing a function as the child to `<Network/>`,
it becomes trivial to understand 😇
...
<CodeSurfer
  ...
  steps={[
    ...
    {
      lines: [1],
      notes: "Directly exporting a class component, no class within a function or anything like the HOC"
    },
    {
      range: [2, 12],
    ...
    {
      range: [14,16],
      notes: "Render the 'children' prop, and run it as a function. Pass relevant arguments"
    },
	{ notes: 'Done! 🥳'}
  ]}
/>
...
<ul style={{ fontSize: "1.5em" }}>
  <Appear>
    ...
    <li>
		It often comes down to a matter of taste, or what the library exposes
    </li>
    <li>
		(as we'll see first hand in the final part)
    </li>
  </Appear>
</ul>
...
2. Use HOCs if you have to combine multiple in *same* component
3. Use HOCs if you have to access enhancement in lifecycle methods

---

- also called children as function
- see https://cdb.reacttraining.com/use-a-render-prop-50de598f11ce for origins

- GUSTAV: DESTRUCTURE PROPS IN FUNCTION???
- FIX HOC USAGE FILE!!!
- GUSTAV: WRITE AN ASSIGNMENT THAT TELLS THEM TO COMPARE MY TWO HOC AND RENDER PROPS EXAMPLES
- GUSTAV: WHAT TO DO WITH SPECIAL CHILDREN PROP?!?! WE USE IT IN OUR IMPLEMENTATION
