...
<CodeSurfer
  ...
  steps={[
    ...
    {
      range: [23, 29],
      notes: "mainComponent if currentPage === /movies"
    },
    { lines: [30] },
    { lines: [37] },
    {
...
- another pattern that solves the same problem as HOCs
- still composition, just a bit different
- instead of wrapping our component with behavior
- we put the behavior *inside* our render(), 
- also called children as function
- see https://cdb.reacttraining.com/use-a-render-prop-50de598f11ce for origins

- arguments
- typescript
- no indirection - also last line export
- no renaming (Base)

- nemmere at st{te} flere sammen
- forces logic into return instead of base
- lifecycles

- viser kun children functions
- implementer Network fra HOC
