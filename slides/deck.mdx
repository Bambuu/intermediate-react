...
# The three concepts of React Router
...
- solution
  - there are many, but use react-router
  - explain that there are differences in v3 and v4
- the concepts - link - route - router
- show example where it all fits together
- withRouter
- get current route anywhere in your app
