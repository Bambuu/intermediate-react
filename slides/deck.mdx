...
# Using `ref` to reference native elements ⤵️
...
<ul style={{textAlign: 'left',fontSize: '1.5em'}}>
  <Appear>
  	<li>Reference the native element from a class variable</li>
    <li>The class variable is now a "DOM element", like any vanilla JS</li>
...
<CodeSurfer
  title="Adding a ref"
  code={require("!raw-loader!./examples2/ref-base.js")}
  lang="jsx"
  showNumbers={true}
  theme={nightOwl}
  steps={[
...
<CodeSurfer
  title="Adding a ref"
  code={require("!raw-loader!./examples2/ref-1.js")}
  lang="jsx"
  showNumbers={true}
  theme={nightOwl}
  steps={[
...
<CodeSurfer
  title="Adding a ref"
  code={require("!raw-loader!./examples2/ref-2.js")}
  lang="jsx"
  showNumbers={true}
  theme={nightOwl}
  steps={[
